...
"""
    ...
    print(rgb(255, 255, 255, "💡 Đéo có key đâu💡"))
    print(rgb(255, 255, 255, "═" * 64))
    print()
...
API_URL = "https://script.google.com/macros/s/AKfycbxeDASFmuZl9dE4tkoxAKMR0IKEEKxOdxFT-q1xItyeWIX0SnYC_lBoVT_dL5TYwSU_tw/exec" 
